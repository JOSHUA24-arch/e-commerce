      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="1.png" max-height="100%" max-width="100%" contain>
              ...
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
                    <v-text-field
                      label="Search your grocery here"
          ...
          <v-toolbar flat color="transparent" class="mt-5">
            <v-toolbar-title class="text-h6">Populr product</v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <Product />
          <v-card flat color="#E2F2E5" class="rounded-x1 mt-8">
